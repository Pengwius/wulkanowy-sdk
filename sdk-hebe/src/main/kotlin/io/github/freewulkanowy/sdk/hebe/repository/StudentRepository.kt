package io.github.freewulkanowy.sdk.hebe.repository

import io.github.freewulkanowy.sdk.hebe.getEnvelopeOrThrowError
...
internal class StudentRepository(private val studentService: StudentService) {
    ...
    suspend fun getHomeworks(pupilId: Int): List<Homework> {
    ...
    private fun createQueryMap(
        ...
        "loginId" to loginId,
        "lastSyncDate" to (lastSyncDate?.format(DateTimeFormatter.ISO_DATE) ?: "1970-01-01 01:00:00"),
