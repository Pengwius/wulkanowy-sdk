package io.github.freewulkanowy.sdk

import io.github.freewulkanowy.sdk.hebe.Hebe
import io.github.freewulkanowy.sdk.mapper.mapAttendance
import io.github.freewulkanowy.sdk.mapper.mapAttendanceSummary
import io.github.freewulkanowy.sdk.mapper.mapCompletedLessons
import io.github.freewulkanowy.sdk.mapper.mapConferences
import io.github.freewulkanowy.sdk.mapper.mapDevices
import io.github.freewulkanowy.sdk.mapper.mapDirectorInformation
import io.github.freewulkanowy.sdk.mapper.mapExams
import io.github.freewulkanowy.sdk.mapper.mapGradePointsStatistics
...
import io.github.freewulkanowy.sdk.mapper.mapLuckyNumbers
import io.github.freewulkanowy.sdk.mapper.mapMailboxes
import io.github.freewulkanowy.sdk.mapper.mapMenu
import io.github.freewulkanowy.sdk.mapper.mapMessages
import io.github.freewulkanowy.sdk.mapper.mapNotes
import io.github.freewulkanowy.sdk.mapper.mapPhoto
import io.github.freewulkanowy.sdk.mapper.mapRecipients
import io.github.freewulkanowy.sdk.mapper.mapSchool
import io.github.freewulkanowy.sdk.mapper.mapScrapperMessage
import io.github.freewulkanowy.sdk.mapper.mapSemesters
import io.github.freewulkanowy.sdk.mapper.mapStudent
import io.github.freewulkanowy.sdk.mapper.mapSubjects
import io.github.freewulkanowy.sdk.mapper.mapTeachers
import io.github.freewulkanowy.sdk.mapper.mapTimetable
import io.github.freewulkanowy.sdk.mapper.mapTimetableFull
import io.github.freewulkanowy.sdk.mapper.mapToScrapperAbsent
import io.github.freewulkanowy.sdk.mapper.mapToUnits
import io.github.freewulkanowy.sdk.mapper.mapToken
import io.github.freewulkanowy.sdk.mapper.mapUser
...
class Sdk {
    ...
    suspend fun getAttendance(startDate: LocalDate, endDate: LocalDate): List<Attendance> = withContext(Dispatchers.IO) {
        when (mode) {
            ...
            Mode.HYBRID, Mode.HEBE -> hebe.getAttendance(startDate, endDate).mapAttendance()
        }
    }
    ...
    suspend fun getHomework(start: LocalDate, end: LocalDate): List<Homework> = withContext(Dispatchers.IO) {
        when (mode) {
            ...
            Mode.HYBRID, Mode.HEBE -> hebe.getHomeworks().mapHomework()
        }
    }
    ...
    suspend fun markMessageRead(messageKey: String) = withContext(Dispatchers.IO) {
        when (mode) {
            Mode.HYBRID, Mode.SCRAPPER -> scrapper.markMessageRead(messageKey)
            Mode.HEBE -> throw NotImplementedError("Not available in HEBE mode")
        }
    }
