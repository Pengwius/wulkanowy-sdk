...
import io.github.freewulkanowy.sdk.scrapper.getGradePointPercent
import io.github.freewulkanowy.sdk.scrapper.getGradeShortValue
...
internal fun GradesResponse.mapGradesSummary() = gradesWithSubjects.map { subject ->
    GradeSummary(
        ...
        pointsSumAllYear = subject.pointsSumAllYear?.trim()?.takeIf { it != "-" },
